...
def func():
    ...
    current_solution = np.array([100,100,1], dtype=int)
    ...
    return (f"{amounts[0]:d} gramos ternera, {amounts[1]:d} gramos de patatas y {amounts[2]:d} puñado(s) de aceitunas (10gr/puñado). Las calorías resultantes serían {round(calories):d}. Los macronutrientes resultantes serían {round(macros[0]):d} gramos de carbohidratos, {round(macros[1]):d} gramos de proteínas y {round(macros[2]):d} gramos de grasas.")
