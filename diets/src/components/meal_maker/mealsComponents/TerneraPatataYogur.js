...
import script from '../pythonScripts/TerneraPatatasYogur.py';
import Foto from '../../assets/imgs/terneraBatata.png'
...
const TerneraPatataYogur = ({ var1, var2, var3}) => {
...
// Move the useEffect code into a new function
  ...
  return (
    <Card style={{ width: '18rem' }} className="mb-2">
       ...
       <Card.Body>
       <Card.Title>Ternera con patatas + yogur</Card.Title>
          <div className="App">
...
export default TerneraPatataYogur;