...
import script from '../pythonScripts/TortitasAvena.py';
import Foto from '../../assets/imgs/tortitas.png'
...
const TortitasAvena = ({ var1, var2, var3}) => {
