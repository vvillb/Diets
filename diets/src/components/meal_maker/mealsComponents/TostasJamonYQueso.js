...
import script from '../pythonScripts/TostaasJamonYQueso.py';
import Foto from '../../assets/imgs/tostasJamonyQueso.png'
...
const TostasJamonYQueso = ({ var1, var2, var3}) => {
...
// Move the useEffect code into a new function
  ...
  return (
    ...
    <Card style={{ width: '18rem' }} className="mb-2">
       ...
       <Card.Body>
       <Card.Title>Tostadas con jamón serrano y queso + dátiles</Card.Title>
          <div className="App">
...
export default TostasJamonYQueso;