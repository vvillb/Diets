...
import script from '../pythonScripts/QuesoFrescoBatidoConAvena.py';
import Foto from '../../assets/imgs/quesoFrescoAvena.png'
...
const QuesoFrescoBatidoConAvena = ({ var1, var2, var3}) => {
...
// Move the useEffect code into a new function
  ...
  return (
    <Card style={{ width: '18rem' }} className="mb-2">
       ...
       <Card.Body>
       <Card.Title>Queso fresco batido con avena, miel y nueces </Card.Title>
          <div className="App">
...
export default QuesoFrescoBatidoConAvena;