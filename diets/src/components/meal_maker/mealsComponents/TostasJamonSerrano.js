...
import script from '../pythonScripts/tostasSerrano.py';



const runScript = async (code, props) => {
  const pyodide = await window.loadPyodide({
    indexURL : "https://cdn.jsdelivr.net/pyodide/v0.18.1/full/pyodide.js"
  });
...
const TostasJamonSerrano= ({ var1, var2, var3}) => {
...
export default TostasJamonSerrano;