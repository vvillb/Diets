...
import script from '../pythonScripts/CornFlakesProteicos.py';
import Foto from '../../assets/imgs/cornflakes.png'
...
const CornFlakesProteicos = ({ var1, var2, var3}) => {
...
// Move the useEffect code into a new function
  ...
  return (
    <Card style={{ width: '18rem' }} className="mb-2">
       ...
       <Card.Body>
       <Card.Title>Corn Flakes Protéicos </Card.Title>
          <div className="App">
...
export default CornFlakesProteicos;