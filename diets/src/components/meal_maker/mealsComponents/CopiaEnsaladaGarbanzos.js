...
import script from '../pythonScripts/CopiaEnsaladaGarbanzos.py';
import Foto from '../../assets/imgs/ensaladaGarbanzos.png'
...
const CopiaEnsaladaGarbanzos = ({ var1, var2, var3}) => {
...
export default CopiaEnsaladaGarbanzos;