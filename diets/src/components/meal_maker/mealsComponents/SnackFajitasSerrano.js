...
import script from '../pythonScripts/SnackFajitasJamon.py';
import Foto from '../../assets/imgs/fajitas.png'
...
const SnackFajitasSerrano = ({ var1, var2, var3}) => {
...
// Move the useEffect code into a new function
  ...
  return (
    <Card style={{ width: '18rem' }} className="mb-2">
       ...
       <Card.Body>
       <Card.Title>Fajitas con Jamón serrano y queso</Card.Title>
          <div className="App">
...
export default SnackFajitasSerrano;