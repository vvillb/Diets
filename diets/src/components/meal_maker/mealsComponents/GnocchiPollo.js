...
import script from '../pythonScripts/GnocchiPollo.py';
import Foto from '../../assets/imgs/gnocchi.png'
...
const GnocchiPollo = ({ var1, var2, var3}) => {
...
// Move the useEffect code into a new function
  ...
  return (
    <Card style={{ width: '18rem' }} className="mb-2">
       ...
       <Card.Body>
       <Card.Title>Gnocchi con pollo</Card.Title>
          <div className="App">
