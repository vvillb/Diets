...
import script from '../pythonScripts/PastaPolloQueso.py';
import Foto from '../../assets/imgs/chickenPasta.png'
...
const PastaPolloQueso = ({ var1, var2, var3}) => {
...
// Move the useEffect code into a new function
  ...
  return (
    <Card style={{ width: '18rem' }} className="mb-2">
       ...
       <Card.Body>
       <Card.Title>Pasta con pollo y queso</Card.Title>
          <div className="App">
...
export default PastaPolloQueso;