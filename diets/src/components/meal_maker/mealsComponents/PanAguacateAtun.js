...
import script from '../pythonScripts/PanAguacateAtun.py';
import Foto from '../../assets/imgs/tostasAtunAguacate.png'
...
const PanAguacateAtun = ({ var1, var2, var3}) => {
...
// Move the useEffect code into a new function
  ...
  return (
    <Card style={{ width: '18rem' }} className="mb-2">
       ...
       <Card.Body>
       <Card.Title>Tostadas con atún y aguacate </Card.Title>
          <div className="App">
...
export default PanAguacateAtun;